...
namespace StayAtHoome.Droid {
  ...
  public class PeriodicLocationTrackerJobService : JobService {
    public override bool OnStartJob(JobParameters @params) {
      new PeriodicLocationTracker().Execute().ContinueWith(
          t => { JobFinished(@params, !t.Result); });
  ...
  public static class JobSchedulerHelpers {
    public static JobInfo.Builder
    CreateJobBuilderUsingJobId<T>(this Context context, int jobId) where T
        : JobService {
    ...
    public static void SchedulePeriodicTrackerJob(this Context context) {
      var builder =
          context
              .CreateJobBuilderUsingJobId<PeriodicLocationTrackerJobService>(1)
              .SetPersisted(false)
              .SetPeriodic(60_000);
